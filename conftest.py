...
# This is example shows how we can manage failed ui-tests
...
def web_browser(request, selenium):
    ...
    if request.node.rep_call.failed:
        # Make a screenshot if test has failed:
        try:
            browser.execute_script("document.body.bgColor = 'white';")

            # Make a screenshot for local debug:
            ...
            pass  # Just ignoring any errors here
